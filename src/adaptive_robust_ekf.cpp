    ...
    while (_running && ros::ok())
    {
        ...
        if (((_imuActivated && enableImu) || (_wheelActivated && enableWheel) || (_lidarActivated && enableLidar)) &&
            ...
            ROS_INFO_STREAM("\033[1;34m--- EKF STATE (X) ---\033[0m" << 
                        ...
                        "\n  BiasL : " << _X.segment(15, 6).transpose() <<
                        "\n  BiasW : " << _X.segment(21, 3).transpose() <<
                        "\n  BiasI : " << _X.segment(24, 6).transpose() <<
                        "\n  T_L/R : " << _X.segment(30, 6).transpose() <<
                        "\n  T_I/R : " << _X.segment(36, 6).transpose() <<
                        "\n\033[1;34m---------------------\033[0m");
